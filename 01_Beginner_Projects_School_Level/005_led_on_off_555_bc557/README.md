# Project 005: LED ON and OFF Dimmer Circuit Using 555 and BC557

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Analog / Transistor Drivers
...
The LED ON and OFF Dimmer Circuit Using 555 and BC557 is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic analog / transistor drivers.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/005_led_on_off_555_bc557/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/005_led_on_off_555_bc557/project_report.pdf)
