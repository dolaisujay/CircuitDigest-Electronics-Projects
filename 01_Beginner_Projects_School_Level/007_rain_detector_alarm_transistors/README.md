# Project 007: Rain Detector Alarm Circuit Using Transistors

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Environmental Sensors / Alarms
...
The Rain Detector Alarm Circuit Using Transistors is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic environmental sensors / alarms.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/007_rain_detector_alarm_transistors/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/007_rain_detector_alarm_transistors/project_report.pdf)
