# Project 035: Simple Light Dimmer Circuit Using TRIAC and DIAC

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: AC Power Control
...
The Simple Light Dimmer Circuit Using TRIAC and DIAC is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic ac power control.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/035_light_dimmer_triac_diac/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/035_light_dimmer_triac_diac/project_report.pdf)
