# Project 002: Reverse Polarity Protection Circuit Using P-Channel MOSFET
...
The Reverse Polarity Protection Circuit Using P-Channel MOSFET is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic power electronics / protection.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/002_reverse_polarity_protection_mosfet/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/002_reverse_polarity_protection_mosfet/project_report.pdf)
