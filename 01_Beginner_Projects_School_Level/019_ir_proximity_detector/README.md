# Project 019: Simple IR Sensor Proximity Detector Circuit

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Infrared Sensors
...
The Simple IR Sensor Proximity Detector Circuit is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic infrared sensors.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/019_ir_proximity_detector/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/019_ir_proximity_detector/project_report.pdf)
