...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Project Report: Electronic Die Circuit Using 555 Timer and CD4017},
    pdfpagemode=UseOutlines,
}

\pagestyle{fancy}
\fancyhf{}
\rhead{Electronic Die Circuit Using 555 Ti}
\lhead{Technical Project Report}
\rfoot{Page \thepage}

\title{\textbf{\Huge Engineering Project Report}\\[0.5em] \Large Project 016: Electronic Die Circuit Using 555 Timer and CD4017}
...
The objective of this project is to implement a robust electronic system for \textbf{Electronic Die Circuit Using 555 Timer and CD4017}. This document details the step-by-step engineering design, component functions, mathematical principles, and experimental results.

\section{Bill of Materials (Components List)}
\begin{table}[h!]
\centering
\caption{Bill of Materials for Electronic Die Circuit Using 555 Timer and CD4017}
\vspace{0.5em}
