# Project 018: Police Siren Sound Generator Circuit Using Dual 555 Timers

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Audio Oscillators
...
The Police Siren Sound Generator Circuit Using Dual 555 Timers is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic audio oscillators.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/018_police_siren_dual_555/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/018_police_siren_dual_555/project_report.pdf)
