# Project 008: Automatic Street Light Control Using LDR and 555 Timer

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Industrial Automation / Relays
...
The Automatic Street Light Control Using LDR and 555 Timer is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic industrial automation / relays.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/008_automatic_street_light_555/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/008_automatic_street_light_555/project_report.pdf)
