# Project 062: Arduino Alcohol Detector Alarm Using MQ-3 Sensor

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Safety and Gas Sensing
...
The Arduino Alcohol Detector Alarm Using MQ-3 Sensor integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded safety and gas sensing.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/062_arduino_alcohol_detector_mq3/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/062_arduino_alcohol_detector_mq3/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/alcohol_detector.ino) directory:
* **Firmware / Script**: [`alcohol_detector.ino`](src/alcohol_detector.ino)
