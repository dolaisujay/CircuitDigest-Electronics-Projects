# Project 039: Arduino Temperature and Humidity Monitor with LCD Output
...
The Arduino Temperature and Humidity Monitor with LCD Output integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded embedded systems.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/039_arduino_temp_humidity_lcd/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/039_arduino_temp_humidity_lcd/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/temp_humidity_lcd.ino) directory:
* **Firmware / Script**: [`temp_humidity_lcd.ino`](src/temp_humidity_lcd.ino)
