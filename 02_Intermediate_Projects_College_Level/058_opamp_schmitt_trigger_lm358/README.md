# Project 058: Op-Amp Comparator Circuit with Hysteresis (Schmitt Trigger)

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Waveform Conditioning
...
The Op-Amp Comparator Circuit with Hysteresis (Schmitt Trigger) integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded waveform conditioning.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/058_opamp_schmitt_trigger_lm358/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/058_opamp_schmitt_trigger_lm358/project_report.pdf)
