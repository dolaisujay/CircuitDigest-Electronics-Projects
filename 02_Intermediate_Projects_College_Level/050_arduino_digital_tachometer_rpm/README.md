# Project 050: Arduino Digital Tachometer / RPM Counter Using IR Sensor
...
The Arduino Digital Tachometer / RPM Counter Using IR Sensor integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded industrial metrology.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/050_arduino_digital_tachometer_rpm/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/050_arduino_digital_tachometer_rpm/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/digital_tachometer.ino) directory:
* **Firmware / Script**: [`digital_tachometer.ino`](src/digital_tachometer.ino)
