# Project 043: ESP32 Wi-Fi Home Automation System with Web Server Control
...
The ESP32 Wi-Fi Home Automation System with Web Server Control integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded iot / smart home.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/043_esp32_wifi_home_automation/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/043_esp32_wifi_home_automation/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/esp32_web_home_automation.ino) directory:
* **Firmware / Script**: [`esp32_web_home_automation.ino`](src/esp32_web_home_automation.ino)
