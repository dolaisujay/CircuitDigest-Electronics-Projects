# Project 067: Automatic Night Lamp Circuit Using Triac and LDR

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: AC Solid State Relays
...
The Automatic Night Lamp Circuit Using Triac and LDR integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded ac solid state relays.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/067_automatic_night_lamp_triac/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/067_automatic_night_lamp_triac/project_report.pdf)
