# Project 063: Arduino Gas Leakage Detector System Using MQ-2 Sensor

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Industrial Gas Alarms
...
The Arduino Gas Leakage Detector System Using MQ-2 Sensor integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded industrial gas alarms.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/063_arduino_gas_leakage_mq2/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/063_arduino_gas_leakage_mq2/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/gas_leakage_detector.ino) directory:
* **Firmware / Script**: [`gas_leakage_detector.ino`](src/gas_leakage_detector.ino)
