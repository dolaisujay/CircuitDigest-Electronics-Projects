# Project 056: ESP32 Bluetooth Low Energy (BLE) Beacon Sensor Node

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Wireless IoT Networks
...
The ESP32 Bluetooth Low Energy (BLE) Beacon Sensor Node integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded wireless iot networks.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/056_esp32_ble_beacon_sensor/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/056_esp32_ble_beacon_sensor/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/esp32_ble_beacon.ino) directory:
* **Firmware / Script**: [`esp32_ble_beacon.ino`](src/esp32_ble_beacon.ino)
