# Project 045: Arduino DC Motor Direction and Speed Control (L298N H-Bridge)

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Robotics / Power Drivers
...
The Arduino DC Motor Direction and Speed Control (L298N H-Bridge) integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded robotics / power drivers.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/045_arduino_l298n_motor_driver/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/045_arduino_l298n_motor_driver/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/l298n_motor_control.ino) directory:
* **Firmware / Script**: [`l298n_motor_control.ino`](src/l298n_motor_control.ino)
