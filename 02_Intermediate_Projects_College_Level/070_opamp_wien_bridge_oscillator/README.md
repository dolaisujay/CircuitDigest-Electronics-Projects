# Project 070: Op-Amp Wien Bridge Sine Wave Oscillator Circuit

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Analog Oscillators
...
The Op-Amp Wien Bridge Sine Wave Oscillator Circuit integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded analog oscillators.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/070_opamp_wien_bridge_oscillator/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/070_opamp_wien_bridge_oscillator/project_report.pdf)
