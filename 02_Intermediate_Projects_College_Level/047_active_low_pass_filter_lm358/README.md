# Project 047: Active Low-Pass Filter Circuit Using LM358 Op-Amp

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Filter Design / Signal Processing
...
The Active Low-Pass Filter Circuit Using LM358 Op-Amp integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded filter design / signal processing.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/047_active_low_pass_filter_lm358/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/047_active_low_pass_filter_lm358/project_report.pdf)
