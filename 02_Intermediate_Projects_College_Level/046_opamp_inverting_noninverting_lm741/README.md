# Project 046: Op-Amp Non-Inverting and Inverting Amplifier Circuit (LM741)

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Analog Processing
...
The Op-Amp Non-Inverting and Inverting Amplifier Circuit (LM741) integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded analog processing.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/046_opamp_inverting_noninverting_lm741/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/046_opamp_inverting_noninverting_lm741/project_report.pdf)
