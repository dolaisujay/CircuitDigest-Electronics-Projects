# Project 061: ESP8266 E-Mail / Telegram Notification System Using Sensors

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: IoT Cloud Messaging
...
The ESP8266 E-Mail / Telegram Notification System Using Sensors integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded iot cloud messaging.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/061_esp8266_email_telegram_notifier/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/061_esp8266_email_telegram_notifier/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/esp8266_telegram_notifier.ino) directory:
* **Firmware / Script**: [`esp8266_telegram_notifier.ino`](src/esp8266_telegram_notifier.ino)
