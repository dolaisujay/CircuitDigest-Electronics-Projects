# Project 040: Arduino Servo Motor Position Control Using Potentiometer

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Mechatronics / Motor Control
...
The Arduino Servo Motor Position Control Using Potentiometer integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded mechatronics / motor control.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/040_arduino_servo_pot_control/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/040_arduino_servo_pot_control/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/servo_pot_control.ino) directory:
* **Firmware / Script**: [`servo_pot_control.ino`](src/servo_pot_control.ino)
