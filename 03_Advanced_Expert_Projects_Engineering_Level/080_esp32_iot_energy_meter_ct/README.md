# Project 080: ESP32 IoT Energy Meter with AC Current Sensor (SCT-013) and Cloud Telemetry

## 📌 Difficulty Tier & Category
* **Tier**: Advanced / Expert (Engineering Level)
* **Category**: Smart Grid / Telemetry
...
The ESP32 IoT Energy Meter with AC Current Sensor (SCT-013) and Cloud Telemetry is an advanced engineering implementation featuring high-frequency switching, closed-loop feedback algorithms, or high-speed DSP processing for maximum efficiency and precision.
...
* Industrial automation, renewable energy systems, electric vehicle power trains, aerospace electronics, and high-performance smart grid / telemetry.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/080_esp32_iot_energy_meter_ct/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/080_esp32_iot_energy_meter_ct/project_report.pdf)


---

## 💻 Source Code & Firmware Implementation
The source code for this project is available in the [`src/`](src/esp32_energy_meter.ino) directory:
* **Firmware / Script**: [`esp32_energy_meter.ino`](src/esp32_energy_meter.ino)
