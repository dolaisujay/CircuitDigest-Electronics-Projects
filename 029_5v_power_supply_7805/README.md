# Project 029: Simple 5V Power Supply Circuit Using LM7805

## 📌 Difficulty Tier & Category
* **Tier**: Beginner (School Level)
* **Category**: Power Regulators
...
The Simple 5V Power Supply Circuit Using LM7805 is designed using discrete components and active silicon ICs. Input signals pass through conditioning networks to switch output loads cleanly and reliably.
...
* School science fairs, electronics laboratory exercises, home automation, and basic power regulators.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/029_5v_power_supply_7805/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/029_5v_power_supply_7805/project_report.pdf)
