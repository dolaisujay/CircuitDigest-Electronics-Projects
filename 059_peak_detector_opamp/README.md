# Project 059: Peak Detector Circuit Using Op-Amp and Capacitor

## 📌 Difficulty Tier & Category
* **Tier**: Intermediate (College Level)
* **Category**: Analog Peak Measurement
...
The Peak Detector Circuit Using Op-Amp and Capacitor integrates hardware sensors and microcontrollers/op-amps. Sensor signals are processed through custom firmware or analog conditioning stages and displayed locally or streamed over Wi-Fi/Bluetooth.
...
* Engineering laboratory projects, IoT sensor nodes, automated environmental monitoring, and embedded analog peak measurement.

---

## 📄 Formal LaTeX Technical Report
The full academic project report is available in two formats within this directory:
* **LaTeX Source**: [`project_report.tex`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/059_peak_detector_opamp/project_report.tex)
* **Compiled PDF Report**: [`project_report.pdf`](file:///c:/Users/Sujay/Desktop/Bigyanlabs%20Projects/059_peak_detector_opamp/project_report.pdf)
